...
from core.model_defaults import resolve_openrouter_model
...
# LLM models (fall back to the OpenRouter free router)
IMPLICATIONS_LLM_MODEL = resolve_openrouter_model("IMPLICATIONS_MODEL")
VALIDATION_LLM_MODEL = resolve_openrouter_model("VALIDATION_MODEL")
    ...
    try:
        ...
        if not new_groups and not full:
            ...
            if existing_portfolios:
                ...
                export_live_data(state, groups, portfolios)
